...
public class CarMaintenanceManager implements CarMaintenanceService{
	...
	@Autowired
	public CarMaintenanceManager(CarMaintenanceDao carMaintenanceDao, ModelMapperService modelMapperService, @Lazy CarService carService, @Lazy RentService rentService) {
